...
<div class="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 py-8" id="editPageRoot">
    <div class="mb-6">
        ...
        <div class="mt-3">
            <h1 class="text-xl font-semibold tracking-tight text-slate-900">Edit Listing</h1>
            <p class="mt-1 text-md text-slate-500">Update the listing details below</p>
        </div>
    </div>

    <form id="editListingForm" class="space-y-6">
        ...
        <section class="bg-white rounded-2xl border border-slate-200 shadow-sm">
            ...
            <div class="p-5 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <div>
                    <label class="block text-md font-semibold text-slate-500">No. of Bedrooms <span class="text-red-500">*</span></label>
                    <div class="mt-1 relative">
                ...
                <div>
                    <label class="block text-md font-semibold text-slate-500">No. of Bathrooms <span class="text-red-500">*</span></label>
                    <div class="mt-1 relative">
        ...
        <section class="bg-white rounded-2xl border border-slate-200 shadow-sm" id="permitSection">
            ...
            <div class="p-5 space-y-4">
                ...
                <!-- Permit Expiry Date -->
                <div>
                    <label class="block text-md font-semibold text-slate-500">Permit Expiry Date</label>
                    <div class="mt-1 relative">
                        <input
                            type="date"
            ...
            <div class="p-5 space-y-6">
                ...
                <div>
                    <div class="flex flex-wrap items-center justify-between gap-3 mb-4">
                        ...
                        <div class="flex items-wrap items-center gap-4">
