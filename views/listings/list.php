<div>
        ...
        <div class="flex flex-wrap items-center justify-center lg:justify-end gap-3 bg-white p-2 rounded-2xl shadow-sm border border-slate-200">
            <div class="relative w-full sm:w-64 ">
                ...
                <input id="searchInput" type="text" placeholder="Search ID, Project..."
                    class="pl-9 pr-4 py-2 text-sm bg-slate-50 border-none rounded-xl focus:ring-2 focus:ring-blue-500 outline-none w-full">
            </div>
            <div class="h-6 w-[1px] bg-slate-200 mx-1"></div>
            <div class="flex items-center gap-2">
                <button id="openFiltersBtn"
                    class="px-4 py-2 text-sm font-semibold text-slate-600 hover:bg-slate-50 rounded-xl transition flex items-center gap-2">
                    <i class="fa-solid fa-sliders"></i> Filters
                </button>
                <a href="?page=listings&action=create"
                    class="px-4 py-2 text-sm font-semibold text-white bg-blue-600 rounded-xl hover:bg-blue-700 shadow-md shadow-blue-100 transition">
                    Add Listing
                </a>
            </div>
        </div>
    ...
    <div id="activeChips" class="mb-4 hidden">
        <div class="flex flex-wrap items-center gap-2">
            <span class="text-xs font-semibold text-slate-500 mr-1">Active:</span>
            <div id="chipsWrap" class="flex flex-wrap gap-2"></div>
            <button
                id="clearAllBtn"
                type="button"
                class="ml-2 text-xs font-semibold text-red-600 hover:text-red-700">
                Clear all
            </button>
        </div>
    </div>
        ...
        <div class="absolute right-0 top-0 h-full w-full sm:w-[420px] bg-white shadow-2xl flex flex-col">
            <div class="px-5 py-4 border-b border-slate-200 flex items-center justify-between">
                <div>
                    ...
                    <p class="text-xs text-slate-500">Narrow down results</p>
                </div>
            ...
            <div class="p-5 overflow-auto space-y-5">
                <div class="grid grid-cols-2 gap-3">
                    <div class="col-span-2">
                        <label class="text-xs font-semibold text-slate-500">Reference</label>
                    ...
                    <div>
                        <label class="text-xs font-semibold text-slate-500">Min Price (AED)</label>
                    ...
                    <div>
                        <label class="text-xs font-semibold text-slate-500">Max Price (AED)</label>
                    ...
                    <div>
                        <label class="text-xs font-semibold text-slate-500">Bedrooms (min)</label>
                    ...
                    <div>
                        <label class="text-xs font-semibold text-slate-500">Bathrooms (min)</label>
                    ...
                    <div>
                        <label class="text-xs font-semibold text-slate-500">Min Size (sqft)</label>
                    ...
                    <div>
                        <label class="text-xs font-semibold text-slate-500">Max Size (sqft)</label>
            ...
            <div class="p-5 border-t border-slate-200 flex items-center justify-between gap-3">
                <button id="resetFiltersBtn" type="button"
                    class="px-4 py-2 rounded-xl text-sm font-semibold text-slate-700 bg-slate-100 hover:bg-slate-200">
                    Reset
                </button>

                <div class="flex gap-2">
                    <button id="cancelFiltersBtn" type="button"
                        class="px-4 py-2 rounded-xl text-sm font-semibold text-slate-600 hover:bg-slate-50 border border-slate-200">
                        Cancel
                    </button>
                    <button id="applyFiltersBtn" type="button"
                        class="px-5 py-2 rounded-xl text-sm font-semibold text-white bg-blue-600 hover:bg-blue-700 shadow-md shadow-blue-100">
                        Apply
                    </button>
                </div>
            </div>
