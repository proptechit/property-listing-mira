<div>
    <div class="flex justify-between items-center mb-6">
        ...
        <button onclick="openDeveloperModal()"
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
        <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody id="developersList" class="bg-white divide-y divide-gray-200">
                <tr>
                    <td colspan="3" class="px-6 py-4 text-center text-gray-500">Loading...</td>
                </tr>
            </tbody>
        </table>
        <div id="developersPagination"></div>
    </div>
</div>
...
<div id="developerModal"
    ...
    <!-- Modal -->
    <div class="relative bg-white rounded-lg shadow-lg border border-gray-200 max-w-md w-full mx-4">
        <div class="p-6">
            ...
            <form id="developerForm" class="space-y-4">
                <input type="hidden" id="developerId" name="id">
                ...
                <div class="flex gap-4 pt-4">
                    ...
                    <button type="button" onclick="closeDeveloperModal()"
